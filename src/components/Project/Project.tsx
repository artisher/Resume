        ...
        <div className="mb-10" ref={sectionRef}>
            ...
            <div className="flex flex-col items-center gap-10 mt-8.5 p-5 rounded-2xl bg-[#ffffff]  lg:flex-row lg:flex-wrap lg:w-[70%] lg:mx-auto lg:gap-15">
                {projectsData.map((project, index) => (
                    <div
                        key={index}
                        className="group cursor-pointer rounded-2xl w-[70%] border-4 pb-2 border-amber-300 flex flex-col lg:w-[30%] hover:bg-[#354459] hover:border-4 hover:border-[#fec500] hover:scale-105 transition-all duration-300 ease-in-out"
                    >
